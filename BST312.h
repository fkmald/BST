...
void BST_312 <ItemType>::insertItem(TreeNode*& t, const ItemType& newItem)
{
    ...
    /*else if (t->left == NULL && newItem < t->data )
        t->left->data = newItem;
    else if (t->right == NULL && newItem < t->data )
...
int BST_312 <ItemType>::countNodes(TreeNode* t) const
{
    ...
    if (t == NULL){
       // count = 1;
        ...
        int countLeft = countNodes(t->left);
        int countRight = countNodes(t->right);
...
{
    vector<ItemType> POTransversal;
    preOrderTraversal(root, POTransversal);
    return POTransversal;
...
{
    vector<ItemType> iOTransversal;
    inOrderTraversal(root, iOTransversal);
    return iOTransversal;
}
...
{
    vector<ItemType> pOTransversal;
    postOrderTraversal(root, pOTransversal);
    return pOTransversal;
}
